...
public class EverlastLogin {
  ...
  public void testEverlastLogin() throws Exception {
    ...
    driver.findElement(By.id("email")).sendKeys("blubd");
    driver.findElement(By.id("email")).click();
    driver.findElement(By.id("email")).clear();
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Activity Trackers & Scales'])[1]/following::span[1]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Add to Wish List'])[1]/following::img[1]")).click();
    driver.findElement(By.id("product-addtocart-button")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Fight Fitness'])[1]/following::span[1]")).click();
